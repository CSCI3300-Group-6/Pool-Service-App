...
export default async function ReportsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Two report type cards side by side — each links to its own full report page */}
      <div className="grid gap-6 md:grid-cols-2">

        {/* Compliance report — covers service logs, chemical logs, incidents, and technician attribution */}
        <Card>
        ...
        {/* Financial report — covers chemical cost totals, pool level costs, and trend charts */}
        <Card>
