  ...
  return (
    ...
    >
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Field label="Target chlorine min (ppm)"><input type="number" step="0.1" {...register("targetChlorineMin")} /></Field>
        <Field label="Target chlorine max (ppm)"><input type="number" step="0.1" {...register("targetChlorineMax")} /></Field>
      </div>
